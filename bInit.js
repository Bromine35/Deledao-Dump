(function () {
    ...
    n("String.prototype.startsWith", function (b) {
    ...
    n("Object.is", function (b) {
        return b ? b : function (d, c) {
            return d === c ? 0 !== d || 1 / d === 1 / c : d !== d && c !== c
        }
    });
    n("Array.prototype.includes", function (b) {
        return b ? b : function (d, c) {
            var e = this;
    ...
    n("String.prototype.includes", function (b) {
        return b ? b : function (d, c) {
    ...
    n("String.prototype.endsWith", function (b) {
        return b ? b : function (d, c) {
    ...
    var r = {
        ...
        ib: function (b) {
            ...
            if (b) {
                r.B = b.f;
                "" !== b.k && (r.i = "/" + b.k);
                12 == b.a ? q.startsWith("dev.") || (q = "dev." + q) : r.v = !0;
        ...
        Ta: function (b) {
            return b !== r.o ? "https://" + r.i + "." + q + r.A : r.M
        }
    };
    var t = {
        a: 33,
